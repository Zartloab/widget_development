...
(function () {
  ...
  function onKeyHandler(e) {
    ...
    if (e.key === 'Tab') {
      ...
      var focusableEls = card.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])'); // If no focusable elements in card, allow normal tab navigation
